...
const Thumbnail = ( { src , fallback , isLive , username } : ThumbnailProps ) => {
    ...
    if( !src ){
        content = (
            <div className="bg-background flex flex-col items-center justify-center w-full gap-y-4 h-full
  ...
  return (
    <div className="group aspect-video relative rounded-md cursor-pointer">
     <div className="rounded-md absolute inset-0 bg-blue-600 opacity-0 
